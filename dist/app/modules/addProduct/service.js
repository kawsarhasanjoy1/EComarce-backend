...
const findSortProductWithTopRating = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield modal_1.default.find().sort({ ratingAverage: -1 }).limit(6);
        console.log(result);
        return result;
    }
    catch (err) {
...
const findDataFromDbIsFlash = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modal_1.default.find({ isFalse: true });
    return result;
});
